...
class HiveSplitSourceProvider
{
    ...
    private void loadPartitionSplits(final HiveSplitSource hiveSplitSource, final SuspendingExecutor suspendingExecutor)
            throws InterruptedException
    {
        ...
        try (ThreadContextClassLoader ignored = new ThreadContextClassLoader(classLoader)) {
            ...
            for (Partition partition : partitions) {
                ...
                SecurityUtils.doAs(HdfsConfiguration.getUserGroupInformation(), new PrivilegedExceptionAction<Void>() {
                    @Override
